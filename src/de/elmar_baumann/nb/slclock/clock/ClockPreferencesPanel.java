...
public class ClockPreferencesPanel extends javax.swing.JPanel implements PropertyChangeListener {
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        boolean showExample = "dateFormatSelection".equals(propertyName)
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        panelButtons.add(buttonShowTimerSettingsGui, gridBagConstraints);
